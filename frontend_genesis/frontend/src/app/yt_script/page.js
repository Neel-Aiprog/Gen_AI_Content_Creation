...
<nav className={styles.navbar}>
      ...
      <div className={styles.contentWrapper}>
        {/* LEFT COLUMN - YOUTUBE SCRIPT GENERATOR */}
        <div className={styles.column}>
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <p className={styles.cardSubtitle}>Generate Youtube script</p>
            </div>
            ...
            <form className={styles.form} onSubmit={handleScript}>
              <div className={styles.inputGroup}>
                ...
                <textarea 
                  ...
                  placeholder="Enter your youtube script topic here..."
                  value={topic1} 
              ...
              <div className={styles.editorBox}>
                ...
                {article_script && editorLoaded ? (
                  ...
                  <div className={styles.editorPlaceholder}>
                    ...
                    <p>Your generated youtube script will appear here...</p>
                    <p className={styles.placeholderHint}>Enter a topic and click "Generate Youtube script"</p>
                  </div>
                )}
              </div>
            </div>
