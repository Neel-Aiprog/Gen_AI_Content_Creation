  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <h1 className={styles.title}>Genesis · AI Youtube description Generator</h1>

        <form className={styles.form} onSubmit={handleDescription}>
          <textarea className={styles.textarea} placeholder="Enter youtube description topic..."
          ...
          <button className={styles.generateButton} disabled={loading}>
            {loading ? "Generating..." : "Generate Youtube description"}
          </button>
        </form>
